...
const Home = () => {
  ...
  return (
    ...
    <form className='form' onSubmit={(e)=>{handleSubmit(e)}}>
        ...
        <input type="email" name="email" placeholder="Give you Booth off ID" required/>
        <label htmlFor="email">Booth Head ID</label>
        <input type="email" name="email" placeholder="Giver your Booth Head ID" required/>
